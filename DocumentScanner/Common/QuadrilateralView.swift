...
final class QuadrilateralView: UIView {
    ...
    public var editable = false {
        didSet {
            ...
            quadLayer.fillColor = editable ? UIColor(white: 0.0, alpha: 0.6).cgColor : UIColor(red: 52/255, green: 199/255, blue: 89/255, alpha: 0.2).cgColor
    ...
    private var isHighlighted = false {
        didSet (oldValue) {
            ...
            quadLayer.fillColor = isHighlighted ? UIColor.clear.cgColor : UIColor(red: 52/255, green: 199/255, blue: 89/255, alpha: 0.2).cgColor
